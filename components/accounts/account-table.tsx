...
Buen día estimad@ ${selectedProfile.nombreCliente}, ¡Felicitaciones! Tu suscripción mensual de ${selectedAccount.nombreServicio} 🍿 te brindará entretenimiento ilimitado y satisfacción absoluta. ¡Eres importante para nosotros!, cualquier novedad escríbenos. ✍️
...
🚀GT Tecnology🚀`;
  ...
  const handleNotifyExpiration = async () => {
    ...
    try {
      ...
      const message = `¡Hola ${selectedProfile.nombreCliente}! Te recordamos que tu suscripción a ${selectedAccount.nombreServicio} con GT Tecnology vence el ${format(selectedProfile.fechaFin || new Date(), "dd/MM/yyyy", { locale: es })}. 
